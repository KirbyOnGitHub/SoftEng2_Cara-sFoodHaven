...
function disableFormFields(modalName, action) {
    // Get all input fields within the specified modal
    const inputFields = document.querySelectorAll(`#${modalName} input, #${modalName} select, #${modalName} textarea`);

    // Disable or enable each input field based on the 'disable' parameter
    inputFields.forEach(inputField => {
        inputField.disabled = action;
    });
}
...
function addIngredientOnTable() {
    ...
    // const stockerName = document.getElementById("stocker-name").value;
    // const stockerAddress = document.getElementById("stocker-address").value;
    // const stockerPhoneNum = document.getElementById("stocker-phone-number").value;
    // const stockerEmail = document.getElementById("stocker-email").value;
...
function fillIngredientForm(ingredientData) {
    ...
    // const stockerNameInput = document.getElementById("stocker-name");
    // const stockerAddressInput = document.getElementById("stocker-address");
    // const stockerPhoneNumInput = document.getElementById("stocker-phone-number");
    // const stockerEmailInput = document.getElementById("stocker-email");
    ...
    // stockerNameInput.value = ingredientData.stockerName;
    // stockerAddressInput.value = ingredientData.stockerAddress;
    // stockerPhoneNumInput.value = ingredientData.stockerPhoneNum;
    // stockerEmailInput.value = ingredientData.stockerEmail;
}
...
function updateIngredientComboBoxes() {
    ...
    const tableRows = document.querySelectorAll("#ingredient-table tbody tr");
    tableRows.forEach(tableRow => {
        const fullName = tableRow.cells[0].textContent.trim(); // Get the full name from the table cell
        comboBoxIds.forEach(comboBoxId => {
            const comboBox = document.getElementById(comboBoxId);
